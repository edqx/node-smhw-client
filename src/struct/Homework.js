...
class Homework {
	constructor(client, response) {
		...
		this.due_on_timestamp = new Date(response.due_on).getTime();
		this.class_group_id = response.class_group_id;
		this.issued_on_timestamp = new Date(response.issued_on).getTime();
		this.published_at_timestamp = new Date(response.published_at).getTime();
		this.created_at_timestamp = new Date(response.created_at).getTime();
